...
def main():
    ...
    #                                  colsample_bytree=0.75, reg_lambda=10, learning_rate=0.01, nthread=8)
...
#
    ...
    with open('d:/Current Projects/Python/Kaggle-User-Authentication/Kaggle-User-Authentication/templates/JM/Results/results/user/xgboost_with_labels/FIMP/semi-optimized_augmentedestimator.pkl', 'rb') as f:
