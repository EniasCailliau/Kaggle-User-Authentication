...
def visualize_feature_importance(trainer, rfe, estimator, train_features, train_labels, train_sessions, location,
    ...
    with open(location + 'feature_importance_rfe.csv', 'w') as csvfile:
        ...
        for i in range(1, train_features.shape[1] / 2, 50):
...
def main():
    ...
    estimator = xgboost.XGBClassifier(n_estimators=150, min_child_weight=1, max_depth=8, gamma=0, subsample=0.75,
                                      colsample_bytree=0.75, reg_lambda=0.1, learning_rate=0.1)
