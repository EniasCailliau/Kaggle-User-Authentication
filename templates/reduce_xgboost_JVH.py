...
def main():
    ...
    current_activity = '5'
    train_features = pd.DataFrame(train_features.values[train_activity_labels.values == current_activity])
    train_subject_labels = pd.DataFrame(train_subject_labels.values[train_activity_labels.values == current_activity])
    train_sessions = pd.DataFrame(train_sessions.values[train_activity_labels.values == current_activity])
    train_activity_labels = pd.DataFrame(train_activity_labels.values[train_activity_labels.values == current_activity])
